          ...
          <div class="video-info">
            ...
            <v-layout>
              <v-flex class="video-info-list">
                ...
                <v-tooltip bottom>
                  <v-btn slot="activator" :href="vCategory" target="_blank" class="grey--text text--lighten-1" fab outline><v-icon>contact_support</v-icon></v-btn>
        ...
        <v-card-actions style="flex-wrap: wrap;">
          ...
          <v-dialog v-model="videoShow" persistent max-width="70%">
            ...
            <v-card class="grey lighten-3">
              <v-card-title class="subheading white">{{ video.title }}</v-card-title>
              <v-card-media>
